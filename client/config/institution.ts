...
export const institutionConfig: InstitutionConfig = {
  ...
  shortName: "UC-CCC",
  platformName: "UCANDO",
  fullName: "The University of Chicago Comprehensive Cancer Center Data Commons Operations (UCANDO)",
  ...
  copyrightYear: "2026",
  tagline: "Enterprise Oncology Integration Hub & RNA-seq Analytics",
