      ...
      <DialogContent className="bg-slate-900 border-slate-800 text-slate-100 max-w-lg">
        ...
        <div className="space-y-4 pt-2">
          ...
          {isAuthenticated && user && (
            <div className="p-3 rounded-xl bg-slate-950 border border-emerald-500/40 flex items-center justify-between gap-3 text-xs">
              <div>
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-xl border text-xs transition-all flex items-start justify-between gap-3 ${
                      isCurrentActive
                        ? "bg-slate-950 border-emerald-500/80 shadow-md shadow-emerald-950/30"
                        : isSelected
