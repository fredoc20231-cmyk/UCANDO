        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-2.5 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <Button
              ...
              className="h-7 px-2 text-[11px] font-semibold border-slate-700 bg-slate-950 hover:bg-slate-800 text-emerald-300 hover:text-emerald-200 shrink-0"
            >
              <FileCode className="w-3.5 h-3.5 mr-1 text-emerald-400" />
            ...
            <Button
              ...
              className="h-7 px-2 text-[11px] font-semibold border-slate-700 bg-slate-950 hover:bg-slate-800 text-rose-300 hover:text-rose-200 shrink-0"
            >
              <Landmark className="w-3.5 h-3.5 mr-1 text-rose-400" />
            ...
            <Button
              ...
              onClick={() => setLoginOpen(true)}
              className={cn(
                "h-7 px-2 text-[11px] font-semibold border transition-colors shrink-0",
                isAuthenticated
            ...
            <div className="flex items-center p-0.5 rounded-lg bg-slate-950 border border-slate-700 text-[11px] shadow-inner gap-0.5 shrink-0">
              <button
                type="button"
                onClick={() => setBgTheme("day")}
                className={cn(
                  "flex items-center gap-1 px-2 py-0.5 rounded-md transition-all text-[11px] font-semibold",
                  bgTheme === "day"
              ...
              >
                <Sun className={cn("w-3 h-3", bgTheme === "day" ? "text-primary-foreground fill-current" : "text-amber-400")} />
                <span>Day</span>
              </button>
              ...
              >
                <Moon className={cn("w-3 h-3", bgTheme === "night" ? "text-white fill-white/20" : "text-indigo-400")} />
                <span>Night</span>
              </button>
              ...
              >
                <CloudIcon className={cn("w-3 h-3", bgTheme === "sky" ? "text-slate-950" : "text-sky-400")} />
                <span>Sky</span>
              </button>
            </div>
          </div>
